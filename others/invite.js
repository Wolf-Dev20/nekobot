...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("RANDOM").setTitle(":heart: Please Invite me: ").setDescription("https://discord.com/api/oauth2/authorize?client_id=764250965796061245&permissions=8&scope=bot")
